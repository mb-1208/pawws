    ...
    <>
      <div className="section-roadmap" id="roadmap">
        ...
        <div className="phase-1">
          <h6  style={{fontSize: '3.5vh'}}>Phase I: Launching Collections</h6>
        ...
        <div className="phase-2">
          <h6  style={{fontSize: '3.5vh'}}>Phase II: Community & Connection</h6>
          <p style={{fontSize: '2.5vh', fontWeight: 'light'}}>
        ...
        <div className="phase-4">
          <h6  style={{fontSize: '3.5vh'}}>Phase IV: Raritytools and ranking (pApps)</h6>
          <p style={{fontSize: '2.5vh', fontWeight: 'light'}}>
            ◎ To be Announce
          </p>
        </div>
